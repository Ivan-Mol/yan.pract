...
public class Practicum {
    ...
    private static void printOrderedByDateReceived(Set<Letter> letters) {
        ...
        TreeSet<Letter> letterTreeSet = new TreeSet<Letter>(Comparator.comparing(letter -> letter.dateReceived));
        letterTreeSet.addAll(letters);
        for (Letter l:letterTreeSet) {
            System.out.println("    * Письмо от " + l.authorName + " поступило " + l.dateReceived);
        }
    }
